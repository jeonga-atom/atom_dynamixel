...
def segmentation_calculate(image, model=None):
    ...
    # else:
    #     angle = calculate_contour_angle(largest_contour)
...
def main():
    ...
    for _ in range(10):  # 약 1초간 프레임 discard
