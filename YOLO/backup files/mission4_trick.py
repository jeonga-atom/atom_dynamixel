            ...
            try:
                ...
                if topic == "reset":
                    ...
                    if topic == "safebox_detection_again":
                        ...
                        socket_detection.send_multipart([DEFAULT_ROS_DETECTED['human_red'].encode(), b''])
                        published_once['human'] = True
                        detection_enabled['human'] = True
                        print(f"Sent {DEFAULT_ROS_DETECTED['human_red']}")
                        ...
                        socket_detection.send_multipart([DEFAULT_ROS_DETECTED['finish'].encode(), b''])
                        published_once['finish'] = True
                        detection_enabled['finish'] = True
                        print(f"Sent {DEFAULT_ROS_DETECTED['finish']}")
        ...
        if detection_enabled['safebox']:
            ...
            for result in results_safebox:
                ...
                for i, box in enumerate(boxes):
                    ...
                    label = f"Safebox conf: {confidence:.2f} Depth: {obj_depth_value:.2f}mm X: {obj_center_x}"
