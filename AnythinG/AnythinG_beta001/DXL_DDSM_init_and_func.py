...
# 기타 변수 정의
DXL_Enabled_state = False
DDSM_Enabled_state = False
...
def Motor_Start_process_for_ATOM():
    for repeat_ID_index in atomConst.DXL_ID_POS:
        Dynmxl_Torque(Motor_ID=repeat_ID_index, ENabled_or_DISabled=1)
    DXL_Enabled_state = True
